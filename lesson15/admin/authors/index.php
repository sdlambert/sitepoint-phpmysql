...
require_once $_SERVER['DOCUMENT_ROOT'] .
		'projects/sitepoint-phpmysql/includes/access.inc.php';

if (!userIsLoggedIn())
{
	echo "Calling login page!";
...
// Adding a new author, form will be blank
if (isset($_GET['add']))
{
...
// We've entered a new author, add them to the DB
...
// We've asked to edit an existing author, send them to the form
...
if (isset($_POST['action']) and $_POST['action'] == 'Edit')
{
	...
	// Populate form with existing author data
...
// We've updated the form, so let's edit the author data in the DB
...
// We've requested to delete an author
